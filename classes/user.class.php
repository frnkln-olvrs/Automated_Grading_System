...
class User {
  ...
  function add() {
    $sql = "INSERT INTO user (emp_id, email, f_name, l_name, m_name, profile_image, acad_rank, user_role, password) VALUES
    (:emp_id, :email, :f_name, :l_name, :m_name, :profile_image, :acad_rank, :user_role, :password);";
